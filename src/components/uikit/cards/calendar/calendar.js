...
//     const calendarDate = i.querySelector('.calendar__date')   
//     const month = calendarDate.children[0]
//     const year = calendarDate.children[1]
//     const monthDays = i.querySelector('.calendar__days')
//     const prevMonth = i.querySelector('.calendar__arrow-prev')
//     const nextMonth = i.querySelector('.calendar__arrow-next')
//     const date = new Date
...
//     const calendarClearBtn = i.querySelector('.calendar__clear-btn')
